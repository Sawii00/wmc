...
/******************************************************************************/
#define AI_WMC_MODEL_NAME          "wmc"
#define AI_WMC_ORIGIN_MODEL_NAME   "wmc"

/******************************************************************************/
#define AI_WMC_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_WMC_IN_NUM        (1)
#define AI_WMC_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 30, 32, 1, 1, NULL), \
}
#define AI_WMC_IN_SIZE { \
  AI_WMC_IN_1_SIZE, \
}
#define AI_WMC_IN_SIZE_BYTES { \
  AI_WMC_IN_1_SIZE_BYTES, \
}
#define AI_WMC_IN_1_HEIGHT      (30)
#define AI_WMC_IN_1_WIDTH       (32)
#define AI_WMC_IN_1_CHANNEL     (1)
#define AI_WMC_IN_1_SIZE        (30 *  32 *  1)
#define AI_WMC_IN_1_SIZE_BYTES  (AI_WMC_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_WMC_OUT_NUM       (1)
#define AI_WMC_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 3, 1, NULL), \
}
#define AI_WMC_OUT_SIZE { \
  AI_WMC_OUT_1_SIZE, \
}
#define AI_WMC_OUT_SIZE_BYTES { \
  AI_WMC_OUT_1_SIZE_BYTES, \
}
#define AI_WMC_OUT_1_CHANNEL     (3)
#define AI_WMC_OUT_1_SIZE        (3)
#define AI_WMC_OUT_1_SIZE_BYTES  (AI_WMC_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_WMC_N_NODES (6)
 ...
 * @ref ai_wmc_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_WMC_*
 * defines into file @ref wmc.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
